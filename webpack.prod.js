...
const project = projects['250128_KM_DUNNA'];

console.log(path.resolve(__dirname, `./src/projects/${project.projectFolder}${project.outputProjectFolder}`));

module.exports = {
    mode: 'production',
    entry: `/src/projects/${project.projectFolder}/js/${project.jsEntry}.js`,

    output: {
        path: path.resolve(__dirname, `./src/projects/${project.projectFolder}${project.outputProjectFolder}`),
        filename: '[name].js',
        publicPath: './'
    },
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.resolve('src', `projects/${project.projectFolder}/${project.pugEntry}.pug`),
